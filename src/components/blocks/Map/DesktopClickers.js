      ...
      <svg  width="618" height="617.789" viewBox="0 0 618 617.789">
        <g id="Group_6958" data-name="Group 6958" transform="translate(-611 -12327)">
          ...
          <Box as='g' id='desktop-clickers'>
            ...
            >
              <PopoverTrigger>
                <g id="venice" transform="translate(-182 78)" onClick={venice.Open} style={{opacity: ((!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) || venice.isOpen) ? '1' : 0}}>
            ...
            >
              <PopoverTrigger>
                <g id="zadar" transform="translate(-55 172)" onClick={zadar.Open} style={{opacity: ((!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) || zadar.isOpen) ? '1' : 0}}>
            ...
            >
              <PopoverTrigger>
                <g id="dubro" transform="translate(70 281)" onClick={dubro.onOpen} style={{opacity: ((!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) || dubro.isOpen) ? '1' : 0}}>
            ...
            >
              <PopoverTrigger>
                <g id="corfu" transform="translate(149 477)" onClick={corfu.onOpen} style={{opacity: ((!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) || corfu.isOpen) ? '1' : 0}}>
            ...
            >
              <PopoverTrigger>
                <g id="argo" transform="translate(168 573)" onClick={argo.onOpen} style={{opacity: ((!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) || argo.isOpen) ? '1' : 0}}>
            ...
            >
              <PopoverTrigger>
                <g id="messina" transform="translate(-74 554)" onClick={messina.onOpen} style={{opacity: ((!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) || messina.isOpen) ? '1' : 0}}>
            ...
            >
              <PopoverTrigger>
                <g id="sorrento" transform="translate(-112 394)" onClick={sorrento.onOpen} style={{opacity: ((!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) || sorrento.isOpen) ? '1' : 0}}>
            ...
            >
              <PopoverTrigger>
                <g id="rome" transform="translate(-240 288)" onClick={rome.onOpen} style={{opacity: ((!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) || rome.isOpen) ? '1' : 0}}>
            ...
            sx={{
              'text': {
                transition: 'opacity 0.5s ease-in-out',
                  ...
                  '&#VENICE-2': {
                    opacity: (venice.isOpen ) ? '1' : '0',
                  },
                  '&#ZADAR-2': {
                    opacity: (zadar.isOpen) ? '1' : '0',
                  },
                  '&#DUBROVNIK': {
                    opacity: (dubro.isOpen) ? '1' : '0',
                  },
                  '&#CORFU-2': {
                    opacity: (corfu.isOpen) ? '1' : '0',
                  },
                  '&#ARGOSTOLI': {
                    opacity: (argo.isOpen) ? '1' : '0',
                  },
                  '&#MESSINA-2': {
                    opacity: (messina.isOpen) ? '1' : '0',
                  },
                  '&#ROME-2': {
                    opacity: (rome.isOpen) ? '1' : '0',
                  },
                  '&#SORRENTO_CAPRI': {
                    opacity: (sorrento.isOpen) ? '1' : '0',
                  },
                  '&.allclose': {
                    opacity: '1!important',
                  }
          ...
          >
              ...
              <text className={(!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) ? 'allclose' : ''} id="VENICE-2" data-name="VENICE" transform="translate(677 12350)" fill="#001736" font-size="18" font-family="AGaramondPro-Regular, Adobe Garamond Pro"><tspan x="-32.949" y="0">VENICE</tspan></text>
              <text className={(!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) ? 'allclose' : ''} id="ZADAR-2" data-name="ZADAR" transform="translate(937 12439)" fill="#001736" font-size="18" font-family="AGaramondPro-Regular, Adobe Garamond Pro"><tspan x="-29.916" y="0">ZADAR</tspan></text>
              <text className={(!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) ? 'allclose' : ''} id="DUBROVNIK" transform="translate(1092 12546)" fill="#001736" font-size="18" font-family="AGaramondPro-Regular, Adobe Garamond Pro"><tspan x="-53.847" y="0">DUBROVNIK</tspan></text>
              <text className={(!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) ? 'allclose' : ''} id="CORFU-2" data-name="CORFU" transform="translate(1146 12749)" fill="#001736" font-size="18" font-family="AGaramondPro-Regular, Adobe Garamond Pro"><tspan x="-30.78" y="0">CORFU</tspan></text>
              <text className={(!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) ? 'allclose' : ''} id="ARGOSTOLI" transform="translate(1178 12873)" fill="#001736" font-size="18" font-family="AGaramondPro-Regular, Adobe Garamond Pro"><tspan x="-50.193" y="0">ARGOSTOLI</tspan></text>
              <text className={(!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) ? 'allclose' : ''} id="MESSINA-2" data-name="MESSINA" transform="translate(876 12873)" fill="#001736" font-size="18" font-family="AGaramondPro-Regular, Adobe Garamond Pro"><tspan x="-37.962" y="0">MESSINA</tspan></text>
              <text className={(!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) ? 'allclose' : ''} id="ROME-2" data-name="ROME" transform="translate(638 12588)" fill="#001736" font-size="18" font-family="AGaramondPro-Regular, Adobe Garamond Pro"><tspan x="-26.1" y="0">ROME</tspan></text>
              <text className={(!dubro.isOpen && !corfu.isOpen && !argo.isOpen && !messina.isOpen && !sorrento.isOpen && !rome.isOpen && !zadar.isOpen && !venice.isOpen ) ? 'allclose' : ''} id="SORRENTO_CAPRI" data-name="SORRENTO/CAPRI" transform="translate(672 12686)" fill="#001736" font-size="18" font-family="AGaramondPro-Regular, Adobe Garamond Pro"><tspan x="-48.276" y="13">SORRENTO</tspan><tspan x="-28.602" y="35">/CAPRI</tspan></text>
          </Box>
        </g>
      </svg>
